...
\item From the deeds file from the years 1984 through 2009.
  ...
  This conversion is made because using age and age squared as features
  is popular in the literature. The idea is that older houses should
  depreciate for a while and then gain in value as they become classics.
  \end{itemize}
