...
time period than most, and the time period before before and after the
real estate price boom in the United States. The systematic exploration
of design choices for linear models leads to results that may surprise
some, including the finding the the most important factor in estimating
real estate prices is not location.
