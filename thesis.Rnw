...
\item Judith Carlin, for many, many proofreading sessions.

\item CoreLogic for providing the data.

\item Davi Geiger for the suggestion to test all features in the
random forests model.

\item Leslie Greengard for continued support and encouragement.

\item John Leahy for a conversation years ago in which he conjectured
...
\item Marco Scoffier for explaining his trick of organization the
