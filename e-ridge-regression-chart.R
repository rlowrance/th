...
Heading.1.and.2OLD <- function(control) {
...
Chart1OLD <- function(control, cv.result, ordered.features) {
...
Chart2OLD <- function(control, cv.result, ordered.features) {
...
Chart3OLD <- function(control, cv.result, ordered.features) {
...
Chart4OLD <- function(control, cv.result, ordered.features) {
    # median of RMedianSE
...
Chart5OLD <- function(control, cv.result, ordered.features) {
