...
Figure \ref{figure:path.13.indicator} shows the estimated generalization errors
...
Figure \ref{figure:path.13.examples.MARE} WRITE ME
...
\label{figure:path.14.rf.1.30}
\end{figure}


Figure \ref{figure:path.14.rf.1.30} shows the results of this experiment. Note that
...
\label{figure:path.14.rf.1.60}
\end{figure}

Figure \ref{figure:path.14.rf.1.60} shows the results of sweeping the random
