...
\subsection{Possibly dropping some features}
...
%
%
%\subsection{Possibly adding some feature}
%
...
%
%<<PCA>>=
%path.always.1 <- control$path.in.e.features.pca.always.chart1
%path.always.1
%path.always.2.1 <- control$path.in.e.features.pca.always.chart2.01
%path.always.2.1
%path.always.2.2 <- control$path.in.e.features.pca.always.chart2.02
%path.always.2.2
%path.always.2.3 <- control$path.in.e.features.pca.always.chart2.03
%path.always.2.3
%@
%
...
%\small
%%\normalsize
%\verbatiminput{\Sexpr{path.always.1}}
%\end{figure}
%
...
%\small
%%\normalsize
%\verbatiminput{\Sexpr{path.always.2.1}}
%\end{figure}
%
...
%\small
%%\normalsize
%\verbatiminput{\Sexpr{path.always.2.2}}
%\end{figure}
%
...
%\small
%%\normalsize
%\verbatiminput{\Sexpr{path.always.2.3}}
%\end{figure}
%
...
%
%Describe and test a model with fewer features.
%
