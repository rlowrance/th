...
e-cv.R: Directory.R Libraries.R Predictors2.R ReadTransactionSplits.R $(e-cv-data)

# this makefile is generated by the program e-cv-generate.R
include e-cv-generate.makefile
